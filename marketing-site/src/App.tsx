        ...
        <section className="hero-grid">
          <div className="hero-copy">
            ...
            <div className="hero-actions">
              <a className="primary-cta" href={releasesUrl} target="_blank" rel="noreferrer">
                Download APK
              </a>
        ...
        <section className="download-section" id="download">
          ...
          <div className="download-panel">
            <div className="download-copy">
              <p className="repo-label">GitHub releases</p>
              <a className="repo-link" href={releasesUrl} target="_blank" rel="noreferrer">
