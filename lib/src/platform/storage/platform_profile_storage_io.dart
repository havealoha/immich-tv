...
ProfileStorage createPlatformProfileStorage() => _IoProfileStorage();

class _IoProfileStorage implements ProfileStorage {
  _IoProfileStorage({FlutterSecureStorage? secureStorage})
